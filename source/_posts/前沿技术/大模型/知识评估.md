...
![img](https://cdn.nlark.com/yuque/0/2023/webp/22608736/1697522825494-4bbd7169-0a93-400a-b230-5d9ea271c724.webp?x-oss-process=image%2Fresize%2Cw_750%2Climit_0)
...
大模型的知识评估是指对大型语言模型的知识和能力进行评估的过程。随着大模型的快速发展，评估其知识和能力的重要性也日益凸显。大模型的知识评估可以帮助我们了解模型在各种任务和领域中的表现。

知识评估主要评估的是对事实的准确性、推理能力、鲁棒性、道德性和偏见等方面的表现。

●事实性(Factuality)：一般就是指幻觉(Hallucination)问题 

![img](https://cdn.nlark.com/yuque/0/2023/webp/22608736/1697525387170-eb0fd563-a670-4dc3-9311-82c0d36b816a.webp?x-oss-process=image%2Fresize%2Cw_750%2Climit_0)

例如在上述例子中，询问chatGPT关于鲁迅和周树人是否是同一个人？给出的回答缺乏事实的准确性。

![img](https://cdn.nlark.com/yuque/0/2023/webp/22608736/1697525388634-dc85c537-0398-4942-964d-5343ae1d4472.webp?x-oss-process=image%2Fresize%2Cw_750%2Climit_0)
...
每个事实都被转换为完形填空语句，例如**"A was born in [MASK]"** 这里的[MASK] 是输入到模型后希望模型预测的部分。通过这种方式就能根据每个模型对固定候选词汇表中每个其他单词的真实标记的排名来评估每个模型，下面介绍几种构造提示词的方式。
